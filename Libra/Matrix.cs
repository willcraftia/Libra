...
namespace Libra
{
    public struct Matrix : IEquatable<Matrix>
    {
        ...
        public static Matrix CreateLook(
            Vector3 position,
            Vector3 direction,
            Vector3 up)
        {
            Matrix result;
            CreateLook(ref position, ref direction, ref up, out result);
            return result;
        }
        ...
        {
            Matrix result;
            CreateLookAt(ref position, ref target, ref up, out result);
            return result;
        }

        // CreateOrthographic は、
        // CreateOrthographicOffCenter(-w/2, w/2, -h/2, h/2, n, f) と等価。
        ...
        public bool ExtractOrthographic(
            out float left,
            out float right,
            out float bottom,
            out float top,
        ...
        // CreatePerspective は、
        // CreatePerspectiveOffCenter(-w/2, w/2, -h/2, h/2, n, f) と等価。
        ...
        // CreatePerspectiveFieldOfView は、
        // yScale = 1/tan(fov/2)
        ...
        public bool ExtractPerspective(
