...
{
    public sealed class LinearDepthMapEffect : IEffect, IEffectMatrices, IDisposable
    {
        ...
        sealed class SharedDeviceResource
        {
            ...
            public SharedDeviceResource(Device device)
            {
                ...
                VertexShader.Initialize(Resources.LinearDepthMapVS);

                PixelShader = device.CreatePixelShader();
                PixelShader.Initialize(Resources.LinearDepthMapPS);
            }
        }
        ...
        public LinearDepthMapEffect(DeviceContext deviceContext)
        {
            if (deviceContext == null) throw new ArgumentNullException("deviceContext");

            DeviceContext = deviceContext;

            sharedDeviceResource = deviceContext.Device.GetSharedResource<LinearDepthMapEffect, SharedDeviceResource>();
