...
namespace Libra.Graphics.Toolkit
{
    public sealed class NormalBilateralFilter : IGaussianFilterEffect, IDisposable
    {
        ...
        public NormalBilateralFilter(DeviceContext deviceContext)
        {
            if (deviceContext == null) throw new ArgumentNullException("deviceContext");

            DeviceContext = deviceContext;

            sharedDeviceResource = deviceContext.Device.GetSharedResource<NormalBilateralFilter, SharedDeviceResource>();
