...
{
    public sealed class BilateralFilterCore : IDisposable
    {
        ...
        public BilateralFilterCore(Device device)
        {
            if (device == null) throw new ArgumentNullException("device");

            this.device = device;

            sharedDeviceResource = device.GetSharedResource<BilateralFilterCore, SharedDeviceResource>();
